...
// 平台抽成管理
export const getCommissionConfig = () => get('/commission/config')
export const getCommissionConfigList = () => get('/commission/config/list')
export const saveCommissionConfig = (data) => post('/commission/config', data)
export const updateCommissionConfig = (data) => put('/commission/config', data)
export const getCommissionRecordPage = (params) => get('/commission/record/page', params)
export const getCommissionStats = () => get('/commission/stats')
export const settleCommissions = (ids) => post('/commission/record/settle', ids)
export const getWithdrawalPage = (params) => get('/commission/withdrawal/page', params)
